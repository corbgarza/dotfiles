pkg_array=("bat" "brightnessctl" "btop" "curl" "eza" "fastfetch" "feh" "fd" "ffmpeg" "fish" "fzf" "gcc" "git" "imagemagick" "kitty" "man-db" "mpv" "neovim" "networkmanager" "noto-fonts" "os-prober" "openssh" "otf-font-awesome" "pulseaudio" "python3" "qutebrowser" "ripgrep" "stow" "tealdeer" "tree" "ttf-arimo-nerd" "udiskie" "vlc" "waybar" "wireplumber" "wofi" "yazi" "yt-dlp" "zoxide")
