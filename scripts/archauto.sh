pkg_array=("bat" "brightnessctl" "btop" "curl" "deno" "eza" "fastfetch" "feh" "fd" "ffmpeg" "fish" "fzf" "gcc" "git" "imagemagick" "kitty" "man-db" "mpv" "neovim" "networkmanager" "nmap" "noto-fonts" "os-prober" "openssh" "otf-font-awesome" "powertop" "pulseaudio" "python3" "qutebrowser" "rclone" "resolvconf" "ripgrep" "stow" "swaybg" "tealdeer" "traceroute" "tree" "ttf-jetbrains-mono-nerd" "tmux" "udiskie" "vlc" "waybar" "wireplumber" "wofi" "yazi" "yt-dlp" "zoxide")
