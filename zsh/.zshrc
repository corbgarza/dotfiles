...
alias gitpulls="cd ~/projects && git pull && echo '\n#### projects pulled ####'; cd ~/dotfiles && git pull && echo '\n#### dotfiles pulled ####\n'; cd ~/Wallpapers && git pull && echo '\n#### Wallpapers pulled ####'; cd ~/"
alias gitpushes="cd ~/projects && gacp && echo '\n#### projects pushed ####\n'; cd ~/dotfiles && gacp && echo '\n#### dotfiles pushed ####\n' ; cd ~/Wallpapers && gacp && echo '\n#### Wallpapers pushed ####'; cd ~"
